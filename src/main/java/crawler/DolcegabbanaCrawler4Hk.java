 ...
 */
public class DolcegabbanaCrawler4Hk extends BaseCrawler {
    /**
     * urls
     */
    protected static List<String> urls = new ArrayList<>();

    public DolcegabbanaCrawler4Hk(int threadDept) {
        super(threadDept);
    }
    ...
    public static void main(String[] args) {
        ...
        new DolcegabbanaCrawler4Hk(1).run();
    }
